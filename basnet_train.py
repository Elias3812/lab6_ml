...
train_num = 0
val_num = 0
mpath=data_dir + tra_image_dir + '*' + image_ext
tra_img_name_list = glob.glob(mpath)

#random_images = random.sample(tra_img_name_list, 2000)
#print(random_images)
#tra_img_name_list=random_images
tra_lbl_name_list = []
...
# ------- 5. training process --------
    ...
    for epoch in range(0, epoch_num):
        ...
        # del temporary outputs and loss
            ...
            if ite_num % 20 == 0:  # save model every 2000 iterations
